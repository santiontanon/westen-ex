...
render_full_room:
	...
	cp 70  ; street alley
	jr z,render_full_room_sprites_alley
	cp 71  ; street3
	jr z,render_full_room_sprites_street3
	cp 72  ; bookstore
	jr z,render_full_room_sprites_bookstore
render_full_room_continue:
	ld de,0
	ld bc,16+SCREEN_HEIGHT*256
	call render_room_rectangle
	ld de,16
	ld bc,16+SCREEN_HEIGHT*256
	jr render_room_rectangle

render_full_room_sprites_street3:
	ld a,(state_choffeur_store)
	or a
	jr z,render_full_room_continue
	SETMEGAROMPAGE_A000 SPRITES_PAGE
	ld hl,object_sprites_attributes_street3
	ld de,SPRATR2+7*4
	ld bc,4
	call fast_LDIRVM
	jr render_full_room_continue


render_full_room_sprites_alley:
	ld a,(state_beggar)
	cp 3  ; beggar is dead
	jr z, render_full_room_continue
	SETMEGAROMPAGE_A000 SPRITES_PAGE
	ld hl,object_sprites_attributes_alley
	ld de,SPRATR2+7*4
	ld bc,8
	call fast_LDIRVM
	jr render_full_room_continue

render_full_room_sprites_bookstore:
	SETMEGAROMPAGE_A000 SPRITES_PAGE
	ld hl,object_sprites_attributes_bookstore
	ld de,SPRATR2+7*4
	ld bc,8
	call fast_LDIRVM
	jr render_full_room_continue
...
render_room_rectangle_safe2:	
	...
	ld a,e
	add a,c
render_room_rectangle_safe2_loop:
	cp 33
	jp m,render_room_rectangle_safe3
	dec c
	ret z
	dec a
	jr render_room_rectangle_safe2_loop
render_room_rectangle_safe3:

	; check top edge:
	ld a,d
	or a
render_room_rectangle_safe_loop3:
	jp p,render_room_rectangle_safe4
	inc d
	dec b
	ret z
	inc a
	jr render_room_rectangle_safe_loop3
render_room_rectangle_safe4:

	; check bottom edge:
	ld a,d
	add a,b
render_room_rectangle_safe4_loop:
	cp SCREEN_HEIGHT+1
	jp m,render_room_rectangle
	dec b
	ret z
	dec a
	jr render_room_rectangle_safe4_loop
...
render_room_rectangle_objects_loop:
				...
				push bc
					push af
						call c,render_room_rectangle_object
					pop af
					call nc,render_room_rectangle_enemy
				pop bc
