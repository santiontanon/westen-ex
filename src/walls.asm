...
setup_wall_white_stone_entrypoint:
	call setup_wall_left_most_corner_ptr
	ld de,wall_data_buffer
...
;-----------------------------------------------
setup_wall_ossuary_ne:
	ld hl,wall_ossuary_zx0
	ld de,wall_data_buffer
	call dzx0_standard
	...
	; Simulate drawing the left side (but not drawing), just to have the pointer at the right place
	; to draw the right wall:
	ld a,(room_height)
	ld b,a
	xor a
	jr setup_wall_ossuary_ne_left_loop_no_reset
setup_wall_ossuary_ne_left_loop:
	and #01
	jr nz,setup_wall_ossuary_ne_left_loop_no_reset
	push bc
		ld bc,-32*2
		add hl,bc
	pop bc
setup_wall_ossuary_ne_left_loop_no_reset:
	push af
	push bc
		inc hl
		inc hl
	...
	pop af
	inc a	
	djnz setup_wall_ossuary_ne_left_loop

	ld de,wall_data_buffer+2
	ld a,(room_width)
	ld b,a
	xor a
	jr setup_wall_ossuary_right_loop_no_reset
setup_wall_ossuary_right_loop:
	and #01
	jr nz,setup_wall_ossuary_right_loop_no_reset
	ld de,wall_data_buffer+2
	push bc
		ld bc,32*2
		add hl,bc
	pop bc
setup_wall_ossuary_right_loop_no_reset:
	push af
	push bc
		inc de
		inc hl
	...
	pop af
	inc a	
	djnz setup_wall_ossuary_right_loop
	ret


;-----------------------------------------------
setup_wall_ossuary_nw:
	ld hl,wall_ossuary_zx0
	ld de,wall_data_buffer
	call dzx0_standard
	...
	ld b,a
	xor a
	jr setup_wall_ossuary_left_loop_no_reset
setup_wall_ossuary_left_loop:
	; check if we need to reset the shelves loop:
	and #01
	jr nz,setup_wall_ossuary_left_loop_no_reset
	ld de,wall_data_buffer
	push bc
		ld bc,-32*2
		add hl,bc
	pop bc
setup_wall_ossuary_left_loop_no_reset:
	push af
	push bc
		inc de
		inc hl
	...
	pop af
	inc a	
	djnz setup_wall_ossuary_left_loop
	ret


;-----------------------------------------------
setup_wall_white_stone:
	ld hl,wall_white_stone_zx0
	ld de,wall_data_buffer
	call dzx0_standard

	jp setup_wall_white_stone_entrypoint


;-----------------------------------------------
setup_wall_white_stone_nw:
	ld hl,wall_white_stone_zx0
	ld de,wall_data_buffer
	call dzx0_standard
	...
	ld b,a
	xor a
	jr setup_wall_white_stone_nw_loop_no_reset
setup_wall_white_stone_nw_loop:
	; check if we need to reset the shelves loop:
	and #01
	jr nz,setup_wall_white_stone_nw_loop_no_reset
	ld de,wall_data_buffer
	push bc
		ld bc,-32*2
		add hl,bc
	pop bc
setup_wall_white_stone_nw_loop_no_reset:
	push af
	push bc
		inc de
		inc hl
	...
	pop af
	inc a	
	djnz setup_wall_white_stone_nw_loop
