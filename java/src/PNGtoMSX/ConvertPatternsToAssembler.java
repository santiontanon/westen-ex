...
public class ConvertPatternsToAssembler {
    ...
    public static String MSXColorNames[] = {
    ...
    public static void setMSXColor(BufferedImage img, int x, int y, int color)
    {
        int rgbcolor = (MSX1Palette[color][0] << 16) +
                       (MSX1Palette[color][1] << 8) +
                       MSX1Palette[color][2] + 0xff000000;
        img.setRGB(x, y, rgbcolor);
    }

    
    public static void setMSXColorSafe(BufferedImage img, int x, int y, int color)
    {
